      ...
      <div className='container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
        ...
        <div>
          ...
          <div className='flex flex-col sm:flex-row gap-4'>
            <Button
              size='lg'
              className='text-base rounded-full px-7 py-6 font-semibold text-black cursor-pointer hover:shadow-[0_0_40px_rgba(240,177,0,0.12)] transition-shadow duration-500'
            >
